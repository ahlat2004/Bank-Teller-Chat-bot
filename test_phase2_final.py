"""
Robust Phase 2 Test Suite - ASCII Compatible Version
...
class RobustPhase2Tester:
    ...
    def test_multiple_requests(self) -> bool:
        ...
        try:
            ...
            if success_count >= len(messages) - 1:
    ...
    def run_all_tests(self) -> bool:
        ...
        if not self.wait_for_server():
            print("[ERROR] Cannot proceed without server")
            return False
        ...
        print(f"\n[OK] Passed: {self.passed}/{total}")
        print(f"[FAIL] Failed: {self.failed}/{total}")
